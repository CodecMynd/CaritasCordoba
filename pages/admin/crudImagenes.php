                            ...
                            <div class="card border-card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a type="button" class="btn btn-secondary" href="../adds/formAddImgInicio.php" data-toggle="tooltip" data-placement="left" title="Registrar Nueva Imagen Pagina Inicio">
                                                <i class="fa-solid fa-user-plus"></i>&nbsp;&nbsp; Registrar Imagen Inicio</a>
