        ...
        <div class="modal-content">
            ...
            <form id="formDeleteImgReporte">
                <div class="modal-footer text-left">
                    ...
                    <button type="submit" id="btnDeleteImgReporte" class="btn btn-secondary"><i class="fas fa-ban"></i> Eliminar</button>
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <div id="respuestaDeleteImgReporte"></div>
                </div>
            </div>
            <div class="pie">
