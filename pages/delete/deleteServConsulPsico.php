...
$ruta = '../../src/img/servicios/consultapsicologica/' . $imgBanner;      
$ruta2 = '../../src/img/servicios/consultapsicologica/' . $imgPrincipal;
...
try {
       ...
       location.href = "../admin/crudServConsulPsico.php";
        </script>';
} catch (Exception $e) {
       $conexion->rollback();
