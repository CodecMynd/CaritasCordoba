...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicios: Luchamos contra el cáncer | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Luchamos contra el Cáncer</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Luchamos contra el Cáncer.</h3>
                        <h5 class="text-white mb-3">Estancia para personas que están en tratamiento contra el cáncer</h5>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    Ubicado en la calle 16 número 1514, avenida 15 y 15 A, se le da hospedaje al enfermo y acompañante quienes vienen a tratamiento de radioterapias o quimioterapias y son de escasos recursos.
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/luchaCancer/1-luchaCancer.png);">
