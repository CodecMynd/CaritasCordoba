                ...
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 pt-5 pb-2 div-info-video">
                        ...
                        <div style="float:right;">
                            <!-- <a href="" class="prevArrowS"><i class="fas fa-angle-left fa-2x"></i></a> -->
                            <a href="contraCancer.php" class="nextArrowS" title="Siguiente: Luchamos contra el Cáncer"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
