...
$query1 = "SELECT * FROM servicios WHERE modulo = 'Servicio Farmacia'";
$respuesta1 = mysqli_query($conexion, $query1);
$row1 = $respuesta1->fetch_assoc();

// query Galeria de Imagenes
$query2 = "SELECT file, descripcion, mes_anio FROM galeriaservicios WHERE modulo = 'Servicio Farmacia'";
...
<body>
    ...
    ?>
    <!-- banner -->
    <section class="page-title overlay" style="background-image: url(../../src/img/servicios/Farmacia/<?php echo $row1['imgBanner'] ?>);">
        <div class="container">
            <div class="row">
    ...
    <section class="overlay" data-aos="fade-left" data-aos-duration="3000">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/farmacia/<?php echo $row1['imgPrincipal'] ?>);">
                ...
                <div class="row filtr-container">
                    <div class="col-lg-3 col-md-4 col-sm-6 p-0 filtr-item" data-category="febrero">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="../../src/img/servicios/farmacia/evidencias/project-1.jpg" alt="project-image">
