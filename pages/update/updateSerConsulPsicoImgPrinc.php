...
$imgPrincipal = $_POST['imgPrincipal'];
    ...
    if (($_FILES["ruta"]["type"] == "image/jpg")
        ...
        if (move_uploaded_file($_FILES["ruta"]["tmp_name"], "../../src/img/servicios/consultapsicologica/" . $_FILES['ruta']['name'])) {
            //more code here...
            ...
            $ruta1 = '../../src/img/servicios/consultapsicologica/' . $imgPrincipal;       
            unlink($ruta1);
