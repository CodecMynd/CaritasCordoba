...
<title>Edición Servicio Escucha de Casos | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">Edición Servicio Escucha de Casos </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../admin/panelAdmin.php"><i class="fa-solid fa-house-user"></i> Home</a></li>
                                <li class="breadcrumb-item active"><i class="fa-solid fa-hand-holding-hand"></i> Edición Servicio Escucha de Casos</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body">
                                    <form id="formUpdateServEscuchaCasos" enctype="multipart/form-data">
                                        ...
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-2 col-sm-12 align-self-center">
                                                    <button type="submit" id="btnUpdateServEscuchaCasos" class="btn btn-secondary btn-block btnNuevoUsuario"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-2 col-sm-12 align-self-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateServEscuchaCasos"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body ">
                                    <form id="formUpdateSerEscCasImgBanner" enctype="multipart/form-data">
                                        <input type="hidden" name="idServicio" id="idServicio" value="<?php echo $idServicio ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 my-2">
                                                    ...
                                                    <a href="../../src/img/servicios/escuchaCasos/<?php echo $row['imgBanner'] ?>" class="btn btn-secondary" download="<?php echo  $row['imgBanner']  ?>" title="Descargar"><i class="fa-solid fa-cloud-arrow-down"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <button type="submit" id="btnUpdateSerEscCasImgBanner" class="btn btn-secondary btn-block"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <a href="javascript:history.go(-1)" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Regresar página anterior"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
                                                </div>
                                                ...
                                                <br>
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateSerEscCasImgBanner"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body ">
                                    <form id="formUpdateSerEscCasImgPrinc" enctype="multipart/form-data">
                                        <input type="hidden" name="idServicio" id="idServicio" value="<?php echo $idServicio ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 my-2">
                                                    ...
                                                    <small id="helpId" class="text-muted">¡Puedes descargar la imagen desde aquí!</small>
                                                    <a href="../../src/img/servicios/escuchaCasos/<?php echo $row['imgPrincipal'] ?>" class="btn btn-secondary" download="<?php echo  $row['imgPrincipal']  ?>" title="Descargar"><i class="fa-solid fa-cloud-arrow-down"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <button type="submit" id="btnUpdateSerEscCasImgPrinc" class="btn btn-secondary btn-block"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <a href="javascript:history.go(-1)" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Regresar página anterior"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
                                                </div>
                                                ...
                                                <br>
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateSerEscCasImgPrinc"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script>
        // Formulario Edición de Sección de Textos --------------------------------------------
        $('#btnUpdateServEscuchaCasos').click(function() {
            $.ajax({
                    url: 'updateServEscuchaCasos.php',
                    type: 'POST',
                    data: $('#formUpdateServEscuchaCasos').serialize(),
                })
                .done(function(res) {
                    $('#respuestaUpdateServEscuchaCasos').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnUpdateServEscuchaCasos").on('click', function() {
            $("#btnUpdateServEscuchaCasos").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnUpdateServEscuchaCasos").css('visibility', 'visible');
            }, 300000);
        });
        ...
        $("form").on("submit", function(e) {
            ...
            var imagen = new FormData($("#formUpdateSerEscCasImgBanner")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'updateSerEscCasImgBanner.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formUpdateSerEscCasImgBanner')[0].reset();
                        } else {
                ...
                .done(function(res) {
                    $('#respuestaUpdateSerEscCasImgBanner').html(res)
                })
        });
        ...
        $("form").on("submit", function(e) {
            e.preventDefault();
            var datos = $(this).serializeArray();
            var imagen = new FormData($("#formUpdateSerEscCasImgPrinc")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'updateSerEscCasImgPrinc.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formUpdateSerEscCasImgPrinc')[0].reset();
                        } else {
                            $("#fracaso").delay(500).fadeIn("slow");
                        }
                    }
                ...
                .done(function(res) {
                    $('#respuestaUpdateSerEscCasImgPrinc').html(res)
                })
        });
    </script>
</body>
