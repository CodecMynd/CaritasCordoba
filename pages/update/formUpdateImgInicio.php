            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">Edición Imagen Módulo Inicio </h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-10">
                            <div class="card border-card">
                                ...
                                <form id="formUpdateImgInicio" enctype="multipart/form-data">
                                    <input type="hidden" name="id_imagen" id="id_imagen" value="<?php echo $id_imagen?>">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-3 col-sm-12 my-1 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name="modulo" id="modulo" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Selecciona un Color de la lista" style="width: 100%;">
                                                        <option value="<?php $row['modulo'] ?>"><?php 
                                                         $tipo = $row['modulo'];
                                                         switch ($tipo) {
                                                            case "carrusel1":
                                                               echo '<strong>Carrusel Principal</strong>';
                                                               break;
                                                            case "carrusel2":
                                                               echo '<strong>Carrusel Secundario</strong>';
                                                               break;
                                                            case "carrusel3":
                                                               echo '<strong>Carrusel Benefactores</strong>';
                                                               break;
                                                         } ?>
                                                        </option>
                                            ...
                                            <label for="image" class="form-label">*Imagen a Modificar: <strong><?php echo $row['file'] ?></strong></label>
                                                ...
                                                <a href="../src/img/inicio/<?php echo  $row['file'] ?>" class="btn btn-secondary" download="Img<?php echo  $row['file']  ?>" title="Descargar"><i class="fa-solid fa-cloud-arrow-down"></i></a>
                                            </div>
                                            <div class="col-12">
                                                <hr>
                                            </div>
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <button type="submit" id="btnNuevoImgInicio" class="btn btn-secondary btn-block btnNuevoUsuario"><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
