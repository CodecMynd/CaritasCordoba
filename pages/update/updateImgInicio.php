...
if (($_FILES["ruta"]["type"] == "image/pjpeg")
    ...
    if (move_uploaded_file($_FILES["ruta"]["tmp_name"], "../src/img/inicio/" . $_FILES['ruta']['name'])) {
        ...
        $query = "UPDATE imagenes SET file = '$file', ruta = '$ruta', titulo = '$titulo', subtitulo = '$subtitulo', descripcion = '$descripcion', modulo = '$modulo', fecha_mod = '$date', id_capM = $id WHERE id_imagen = $id_imagen";
        // var_dump($query);
