...
<title>Edición Servicio Consulta Psicológica | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">Edición Servicio Consulta Psicológica </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../admin/panelAdmin.php"><i class="fa-solid fa-house-user"></i> Home</a></li>
                                <li class="breadcrumb-item active"><i class="fa-solid fa-hand-holding-hand"></i> Edición Servicio Consulta Psicológica</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body">
                                    <form id="formUpdateServConsulPsico" enctype="multipart/form-data">
                                        ...
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-2 col-sm-12 align-self-center">
                                                    <button type="submit" id="btnUpdateServConsulPsico" class="btn btn-secondary btn-block btnNuevoUsuario"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-2 col-sm-12 align-self-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateServConsulPsico"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body ">
                                    <form id="formUpdateSerConsulPsicoImgBanner" enctype="multipart/form-data">
                                        <input type="hidden" name="idServicio" id="idServicio" value="<?php echo $idServicio ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 my-2">
                                                    ...
                                                    <a href="../../src/img/servicios/consultapsicologica/<?php echo $row['imgBanner'] ?>" class="btn btn-secondary" download="<?php echo  $row['imgBanner']  ?>" title="Descargar"><i class="fa-solid fa-cloud-arrow-down"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <button type="submit" id="btnUpdateSerConsulPsicoImgBanner" class="btn btn-secondary btn-block"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <a href="javascript:history.go(-1)" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Regresar página anterior"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
                                                </div>
                                                ...
                                                <br>
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateSerConsulPsicoImgBanner"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card card-secondary card-outline collapsed-card border-card">
                                ...
                                <div class="card-body ">
                                    <form id="formUpdateSerConsulPsicoImgPrinc" enctype="multipart/form-data">
                                        <input type="hidden" name="idServicio" id="idServicio" value="<?php echo $idServicio ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-12 col-sm-12 my-2">
                                                    ...
                                                    <small id="helpId" class="text-muted">¡Puedes descargar la imagen desde aquí!</small>
                                                    <a href="../../src/img/servicios/consultapsicologica/<?php echo $row['imgPrincipal'] ?>" class="btn btn-secondary" download="<?php echo  $row['imgPrincipal']  ?>" title="Descargar"><i class="fa-solid fa-cloud-arrow-down"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer border-footer">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <button type="submit" id="btnUpdateSerConsulPsicoImgPrinc" class="btn btn-secondary btn-block"><i class="fas fa-pen"></i> Guardar</buttom>
                                                </div>
                                                <div class="col-md-3 col-sm-6 align-self-center">
                                                    <a href="javascript:history.go(-1)" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="bottom" title="Regresar página anterior"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
                                                </div>
                                                ...
                                                <br>
                                                <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                    <div id="respuestaUpdateSerConsulPsicoImgPrinc"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script>
        // Formulario Edición de Sección de Textos --------------------------------------------
        $('#btnUpdateServConsulPsico').click(function() {
            $.ajax({
                    url: 'updateServConsulPsico.php',
                    type: 'POST',
                    data: $('#formUpdateServConsulPsico').serialize(),
                })
                .done(function(res) {
                    $('#respuestaUpdateServConsulPsico').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnUpdateServConsulPsico").on('click', function() {
            $("#btnUpdateServConsulPsico").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnUpdateServConsulPsico").css('visibility', 'visible');
            }, 300000);
        });
        ...
        $("form").on("submit", function(e) {
            ...
            var imagen = new FormData($("#formUpdateSerConsulPsicoImgBanner")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'updateSerConsulPsicoImgBanner.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formUpdateSerConsulPsicoImgBanner')[0].reset();
                        } else {
                ...
                .done(function(res) {
                    $('#respuestaUpdateSerConsulPsicoImgBanner').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnUpdateSerConsulPsicoImgBanner").on('click', function() {
            $("#btnUpdateSerConsulPsicoImgBanner").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnUpdateSerConsulPsicoImgBanner").css('visibility', 'visible');
            }, 300000);
        });
        ...
        $("form").on("submit", function(e) {
            e.preventDefault();
            var datos = $(this).serializeArray();
            var imagen = new FormData($("#formUpdateSerConsulPsicoImgPrinc")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'updateSerConsulPsicoImgPrinc.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formUpdateSerConsulPsicoImgPrinc')[0].reset();
                        } else {
                            $("#fracaso").delay(500).fadeIn("slow");
                        }
                    }
                ...
                .done(function(res) {
                    $('#respuestaUpdateSerConsulPsicoImgPrinc').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnUpdateSerConsulPsicoImgPrinc").on('click', function() {
            $("#btnUpdateSerConsulPsicoImgPrinc").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnUpdateSerConsulPsicoImgPrinc").css('visibility', 'visible');
            }, 300000);
        });
    </script>
</body>
