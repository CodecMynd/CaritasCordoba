...
?>
<title>Registrar Servicio Consulta Psicológica | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">Registrar Servicio Consulta Psicológica </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../admin/panelAdmin.php"><i class="fa-solid fa-house-user"></i> Home</a></li>
                                <li class="breadcrumb-item active"><i class="fa-solid fa-hand-holding-hand"></i> Registrar Servicio Consulta Psicológica</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="card border-card">
                                ...
                                <form id="formAddServConsulPsico" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <button type="submit" id="btnAddServConsulPsico" class="btn btn-secondary btn-block btnNuevoUsuario"><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaAddServConsulPsico"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        ...
        $("form").on("submit", function(e) {
            ...
            var imagen = new FormData($("#formAddServConsulPsico")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'addNuevoServConsulPsico.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formAddServConsulPsico')[0].reset();
                        } else {
                ...
                .done(function(res) {
                    $('#respuestaAddServConsulPsico').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnAddServConsulPsico").on('click', function() {
            $("#btnAddServConsulPsico").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnAddServConsulPsico").css('visibility', 'visible');
            }, 300000);
        });
    </script>
</body>
