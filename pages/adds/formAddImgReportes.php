...
?>
<title>Registrar Imagen Módulo Reportes | <?php echo $nomComp ?></title>
...
<body class="hold-transition layout-top-nav layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row my-3 mx-5">
                        <div class="col-sm-6">
                            <h1 class="float-left m-0">Registrar Imagen Módulo Reportes </h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="card border-card">
                                ...
                                <form id="formAddImgReportes" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                    ...
                                    <div class="card-footer border-footer">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                                <button type="submit" id="btnAddImgReportes" class="btn btn-secondary btn-block btnReportes"><i class="fas fa-pen"></i> Guardar</buttom>
                                            </div>
                                            <div class="col-md-2 col-sm-12 align-self-center">
                                            ...
                                            <div class="col-md-12 col-sm-12 align-self-center mt-2">
                                                <div id="respuestaAddImgReportes"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    require '../componentsAdmin/modal-ImgReporte.php';
    ?>
    <script>
        // Mostrar modal automatico al abrir el formulario
        $(document).ready(function() {
            $('#modal-ImgReporte').modal('toggle')
        });
        // Capturar formulario Modulo Inicio
        $("form").on("submit", function(e) {
            e.preventDefault();
            var datos = $(this).serializeArray();
            var imagen = new FormData($("#formAddImgReportes")[0]);
            ...
            $.ajax({
                    type: 'post',
                    url: 'addImgReporte.php',
                    data: imagen,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        if (response != 0) {
                            $('#formAddImgReportes')[0].reset();
                        } else {
                ...
                .done(function(res) {
                    $('#respuestaAddImgReportes').html(res)
                })
        });
        //Ocultar boton por 5 minutos para evitar el doble submit
        $("#btnAddImgReportes").on('click', function() {
            $("#btnAddImgReportes").css('visibility', 'hidden');
            setTimeout(function() {
                $("#btnAddImgReportes").css('visibility', 'visible');
            }, 300000);
        });
    </script>
</body>
