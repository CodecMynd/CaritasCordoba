...
$ruta1 = 'Servicio Escucha de Casos';
$modulo = 'Servicio Escucha de Casos';
...
move_uploaded_file($_FILES["ruta"]["tmp_name"], "../../src/img/servicios/escuchaCasos/" . $_FILES['ruta']['name']);
//more code here...
...
move_uploaded_file($_FILES["ruta2"]["tmp_name"], "../../src/img/servicios/escuchaCasos/" . $_FILES['ruta2']['name']);
//more code here...
//  echo '../src/img/inicio/'.$_FILES['ruta']['name'];
...
// var_dump($query);
 ...
 if ($resultado) {
     echo "<div class='alert alert-success' role='alert'>
           <p><strong>Registro Servicio Escucha de Casos ingresado correctamente!</strong></p>
           </div>";
     exit;
 } else {
     echo "<div class='alert alert-danger' role='role'>
