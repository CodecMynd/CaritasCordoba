...
$ruta1 = 'Servicio Farmacia';
$modulo = 'Servicio Farmacia';
...
move_uploaded_file($_FILES["ruta"]["tmp_name"], "../../src/img/servicios/farmacia/" . $_FILES['ruta']['name']);
//more code here...
...
move_uploaded_file($_FILES["ruta2"]["tmp_name"], "../../src/img/servicios/farmacia/" . $_FILES['ruta2']['name']);
//more code here...
//  echo '../src/img/inicio/'.$_FILES['ruta']['name'];
...
// var_dump($query);
 ...
 if ($resultado) {
     echo "<div class='alert alert-success' role='alert'>
           <p><strong>Registro Servicio Farmacia ingresado correctamente!</strong></p>
           </div>";
     exit;
 } else {
     echo "<div class='alert alert-danger' role='role'>
